...
import json
import requests
aurora_testing_url = 'https://mainnet.aurora.dev'
web3 = Web3(Web3.HTTPProvider(aurora_testing_url))

# auroraswap abi and masterchef contract
...
# Here you can put your pool index:
poolInfo = master_contract.functions.poolInfo(1).call() 
allocPoint = poolInfo[1]

# get current liquidity of the pool via dexscreener API
poolAddress = poolInfo[0]
dexscreener_api_url = 'https://api.dexscreener.io/latest/dex/pairs/aurora/'
dexscreener_api_url += poolAddress
response = requests.get(dexscreener_api_url)
response_json = json.loads(response.content)
liquidity = response_json['pair']['liquidity']['usd']

# get current BRL price
response = requests.get('https://api.coingecko.com/api/v3/coins/borealis')
response_json = json.loads(response.content)
price = response_json['market_data']['current_price']['usd']

# calculations
annual_token_emission = BRLPerBlock / 1000000000000000000 * 31556926 / 1.1;
